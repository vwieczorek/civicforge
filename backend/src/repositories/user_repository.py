...
class UserRepository(BaseRepository):
    ...
    async def create_user(self, user: User) -> User:
        ...
        try:
            ...
            self.table.put_item(
                Item=user_dict, ConditionExpression="attribute_not_exists(userId)"
            )
    ...
    async def award_rewards(self, user_id: str, xp: int, reputation: int) -> bool:
        ...
        try:
            ...
            self.logger.info(
                "rewards_awarded", user_id=user_id, xp=xp, reputation=reputation
            )
            return True
    ...
    async def deduct_quest_points(self, user_id: str, points: int) -> bool:
        ...
        try:
            ...
            self.logger.info("quest_points_deducted", user_id=user_id, points=points)
            return True
    ...
    async def award_quest_points(self, user_id: str, points: int) -> bool:
        ...
        try:
            ...
            self.logger.info("quest_points_awarded", user_id=user_id, points=points)
            return True
    ...
    async def update_wallet_address(self, user_id: str, wallet_address: str) -> bool:
        ...
        try:
            ...
            self.logger.info(
                "wallet_address_updated", user_id=user_id, wallet_address=wallet_address
            )
            return True
    ...
    async def award_rewards_idempotently(
        self, user_id: str, reward_id: str, xp: int, reputation: int
    ) -> bool:
        ...
        try:
            ...
            update_expr = (
                f"SET {', '.join(update_parts)} ADD processedRewardIds :reward_id_set"
            )
            ...
            if e.response["Error"]["Code"] == "ConditionalCheckFailedException":
                self.logger.info(
                    "reward_already_processed", user_id=user_id, reward_id=reward_id
                )

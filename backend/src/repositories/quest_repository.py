...
class QuestRepository(BaseRepository):
    ...
    async def get_for_update(self, quest_id: str) -> Optional[Quest]:
        ...
        try:
            response = self.table.get_item(
                Key={"questId": quest_id}, ConsistentRead=True
            )
    ...
    async def list_by_status(
        self, status: QuestStatus, page_size: int = 20, start_key: Optional[Dict] = None
    ...
    async def claim_quest(self, quest_id: str, performer_id: str) -> bool:
        ...
        try:
            ...
            self.logger.info(
                "quest_claimed", quest_id=quest_id, performer_id=performer_id
            )
            return True
    ...
    async def submit_quest(
        ...
        try:
            ...
            self.logger.info(
                "quest_submitted", quest_id=quest_id, performer_id=performer_id
            )
            return True
    ...
    async def add_attestation(
        ...
        try:
            ...
            condition_field = (
                ...
                if attestation_type == AttestationType.REQUESTOR
    ...
    async def dispute_quest(
        self, quest_id: str, user_id: str, dispute_reason: str
    ) -> bool:
        ...
        try:
            ...
            self.logger.info("quest_disputed", quest_id=quest_id, user_id=user_id)
            return True
    ...
    async def delete_quest(self, quest_id: str, creator_id: str) -> bool:
        ...
        try:
            ...
            self.logger.info("quest_deleted", quest_id=quest_id, creator_id=creator_id)
            return True

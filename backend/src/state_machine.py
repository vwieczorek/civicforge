...
class QuestStateMachine:
    ...
    def validate_transition(
        quest: Quest, user_id: str, from_status: QuestStatus, to_status: QuestStatus
        ...
        transition_type = QuestStateMachine.ALLOWED_TRANSITIONS[
    ...
    def can_user_attest(quest: Quest, user_id: str) -> bool:
        ...
        is_participant = QuestStateMachine._is_requestor(
            quest, user_id
        ) or QuestStateMachine._is_performer(quest, user_id)
    ...
    def is_ready_for_completion(quest: Quest) -> bool:
        ...
        return (
            ...
            and QuestStateMachine._has_dual_attestation(quest)
        )
    ...
    def can_user_dispute(quest: Quest, user_id: str) -> bool:
        ...
        return QuestStateMachine._is_requestor(
            quest, user_id
        ) or QuestStateMachine._is_performer(quest, user_id)
